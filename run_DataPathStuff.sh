...
EXPERIMENTATION_JAR_PATH="/Users/dcsl/wf/GraalJSExperiments/experimentation/target/DatapathTypeScript-1.0.jar"
...
${JAVA_PATH}/java                                                                       \
    ...
    @ours-module-path.txt                                                               \
    -Xms8g -Xmx8g -XX:ReservedCodeCacheSize=256m                                        \
    --enable-native-access=org.graalvm.truffle                                          \
    --sun-misc-unsafe-memory-access=allow                                               \
    -jar ./experimentation/target/junit-platform-console-standalone-1.11.3.jar          \
    --classpath ${EXPERIMENTATION_JAR_PATH}                                             \
    --scan-class-path
#    com.amazon.datapath.tests.ProtonBooleanProxyTest
